    ...
    <section className="py-14 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      <div className="hidden md:grid grid-cols-3 gap-4 max-w-5xl mx-auto">
        {domains.slice(0, 6).map(d => (
          <DomainCard key={d.label} {...d} desktop />
        ))}
        {/* Last card centered */}
        <div className="col-span-3 flex justify-center">
          <div className="w-1/3">
            <DomainCard {...domains[6]} desktop />
          </div>
        </div>
      </div>

      {/* Mobile: 2-col grid with icon left */}
...
function DomainCard({ icon, label, desktop }) {
  if (desktop) {
    return (
      <div className="flex flex-col items-center text-center p-6 border border-gray-200 rounded-xl hover:shadow-md transition-shadow">
        <span className="text-blue-600 mb-3">{icon}</span>
